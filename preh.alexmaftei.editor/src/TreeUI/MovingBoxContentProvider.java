...
import TreeModel.DeltaEvent;
import TreeModel.IDeltaListener;
...
public class MovingBoxContentProvider implements ITreeContentProvider, IDeltaListener {
	...
	*/
	public void inputChanged(Viewer viewer, Object oldInput, Object newInput) {
		...
		if(oldInput != null) {
			removeListenerFrom((TreeElement)oldInput);
		}
		if(newInput != null) {
			addListenerTo((TreeElement)newInput);
		}
	}
	...
	protected void removeListenerFrom(TreeElement box) {
		box.removeListener(this);
		for (Iterator<?> iterator = box.getBoxes().iterator(); iterator.hasNext();) {
			TreeElement aBox = (TreeElement) iterator.next();
	...
	protected void addListenerTo(TreeElement box) {
	...
	public Object[] getChildren(Object parentElement) {
		if(parentElement instanceof TreeElement) {
			TreeElement box = (TreeElement)parentElement;
	...
	public Object getParent(Object element) {
		if(element instanceof Model) {
			return ((TreeModel.Model)element).getParent();
		}
		return null;
	}
	...
	public void add(DeltaEvent event) {
		Object movingBox = ((TreeModel.Model)event.receiver()).getParent();
